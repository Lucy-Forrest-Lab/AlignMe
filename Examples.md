...
### Similarity Score File for a pair-wise sequence alignment 
...
used in the examples). An example substitution matrix is given [here]().
...
```*./alignme.exe --fasta_file1 ./examples/fastas/1H2S_A.fa
--fasta_file2 ./examples/fastas/2EI4_A.fa --similarity_score_file
./examples/similarity_scorefiles/matrix.txt```
...
[sections on inputs]() and [overview of flags]().
...
```*/alignme.exe --fasta_file1 ./examples/fastas/1H2S_A.fa
--fasta_file2 ./examples/fastas/2EI4_A.fa --similarity_score_file
./examples/similarity_scorefiles/PSSM.txt --output_aligned_profiles
my_aligned_PSSMs.aln ```
...
```./alignme.exe --fasta_file1 ./examples/fastas/1H2S_A.fa
--fasta_file2 ./examples/fastas/2EI4_A.fa --similarity_score_file
./examples/similarity_scorefiles/PSSMprofile.txt
--output_aligned_profiles my_aligned_profile PSSMs.aln```
...
```alignme.exe --fasta_file1 ./examples/fastas/1H2S_A.fa
--fasta_file2 ./examples/fastas/2EI4_A.fa --similarity_score_file
./examples/similarity_scorefiles/scale.txt```
...
``alignme1.2.exe --fasta\_file1 ./examples/fastas/1H2S_A.fa
--fasta_file2 ./examples/fastas/2EI4_A.fa --similarity_score_file
./examples/similarity_scorefiles/scale.txt --output_aligned_profiles my_aligned_profiles.aln```
...
```alignme1.2.exe --fasta_file1 ./examples/fastas/1H2S_A.fa
--fasta_file2 --similarity_score_file
./examples/similarity_scorfiles/profile.txt --output_aligned_profiles
my_aligned_profiles.aln```

#### E) Pair-wise alignment of 2 sequences based on combined inputs 

```alignme.exe --fasta_file1 ./examples/1KPL.fa --fasta_file2
./examples/1OTS.fa --similarity_score_file ./examples/similarity_scorefiles/combined.txt
...
```alignme.exe --msa_file1 ./examples/bcct.fa --msa_file2
./examples/deda.fa --similarity_score_file ./examples/simscore_msa.txt
...
```alignme.exe --similarity_score_file
./examples/similarity_score_files/profile.txt
--output_aligned_profiles my_aligned_profiles.aln```

You should have a look at your aligned profiles that will be written to
**my_aligned_profiles.aln**.
